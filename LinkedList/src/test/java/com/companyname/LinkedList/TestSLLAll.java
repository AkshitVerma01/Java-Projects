...
public class TestSLLAll {
	...
	// Negative Test
	@Test
	public void testSLLSet0Array() {

		int[] arr = { 0, 0, 0 }; // this list

		SLLSet listObj2 = new SLLSet(arr);
		String expectedSet = "0, 0, 0";
		int expectedSize = 3;
		assertEquals(expectedSize, listObj2.getSize());
		assertEquals(expectedSet, listObj2.toString());
	}
	...
	// Test's the add method too
	// Negative number and checks that its sorted
	@Test
	...
	// Added it to the copy test case
	@Test
	...
	// All cases for remove remove are tested
	@Test
	...
	// If this array is empty and the 2nd array is non empty
	@Test
	...
	// Only one element should get printed
	// Imagining inserting a 0 matrix
	@Test

...
public class matrixTest {
	...
	@Test
	public void testGetElementValid1() {
		// for constructor2
		int[][] data = { { 1, 2, 3, 4, 5 }, { 6, 7, 8, 9, 0 }, { 0, 0, 1, 2, 3 }, { 0, 0, 0, 4, 5 } };
		Matrix f = new Matrix(data);

		int expected = 1;
		assertEquals(expected, f.getElement(0, 0));
	...
	public void testAddToInvalid() {
		int[][] add_to_data = { { 3, 4, 5 }, { 1, 2, 3 }, { 0, 0, 0 }, { 1, 2, 1 } }; // add to 'data' matrix, dimension
																						// not match
	...
	public void testIsUpperTrFalseNotSquare() {
		...
		int[][] notUpper2 = { { 1, 4, 1 }, { 1, 9, 1 }, { 0, 2, 4 } }; // not a square matrix (wrong, it is square but
																		// not upper)
	...
	// Also tests getDim
	@Test
	public void testUpperGetElementValid1() {
		// for constructor2
		int[][] con2_11 = { { 1, 2, 3, 4, 5 }, { 0, 6, 7, 8, 9 }, { 0, 0, 10, 11, 12 }, { 0, 0, 0, 13, 14 },
				{ 0, 0, 0, 0, 15 } };
		Matrix con2_1 = new Matrix(con2_11);
		...
		int expected = 1;
		assertEquals(expected, m3.getElement(0, 0));
	...
	@Test
	public void testUpperSetElementValid1() {
		int value = -1;
		int setvalid_row = 0, setvalid_col = 0;
		int[][] con2_11 = { { 1, 2, 3, 4, 5 }, { 0, 6, 7, 8, 9 }, { 0, 0, 10, 11, 12 }, { 0, 0, 0, 13, 14 },
				{ 0, 0, 0, 0, 15 } };
